...
"")
        ...
        self.MTSpinBox = QtWidgets.QDoubleSpinBox(self.groupBox_8)
        self.MTSpinBox.setMinimumSize(QtCore.QSize(50, 0))
        self.MTSpinBox.setMaximumSize(QtCore.QSize(50, 16777215))
        self.MTSpinBox.setStyleSheet("QDoubleSpinBox{\n"
...
"border-image: url(:/img/icon/箭头_列表收起.png);}\n"
"")
        self.MTSpinBox.setMaximum(1.0)
        self.MTSpinBox.setSingleStep(0.01)
        self.MTSpinBox.setProperty("value", 0.45)
        self.MTSpinBox.setObjectName("MTSpinBox")
        self.horizontalLayout_4.addWidget(self.MTSpinBox)
        self.MTSlider = QtWidgets.QSlider(self.groupBox_8)
        self.MTSlider.setStyleSheet("QSlider{\n"
"border-color: #bcbcbc;\n"
"color:#d9d9d9;\n"
"}\n"
...
"}")
        self.MTSlider.setMaximum(100)
        self.MTSlider.setProperty("value", 45)
        self.MTSlider.setOrientation(QtCore.Qt.Horizontal)
        self.MTSlider.setObjectName("MTSlider")
        self.horizontalLayout_4.addWidget(self.MTSlider)
...
"")
        ...
        self.T2SpinBox = QtWidgets.QDoubleSpinBox(self.groupBox_8)
        self.T2SpinBox.setMinimumSize(QtCore.QSize(50, 0))
        self.T2SpinBox.setMaximumSize(QtCore.QSize(50, 16777215))
        self.T2SpinBox.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.T2SpinBox.setStyleSheet("QDoubleSpinBox{\n"
"background:rgba(200, 200, 200,50);\n"
"color:white;\n"
"font-size: 14px;\n"
"font-family: \"Microsoft YaHei UI\";\n"
...
"border-image: url(:/img/icon/箭头_列表收起.png);}\n"
"")
        self.T2SpinBox.setMaximum(1.0)
        self.T2SpinBox.setSingleStep(0.01)
        self.T2SpinBox.setProperty("value", 0.25)
        self.T2SpinBox.setObjectName("T2SpinBox")
        self.horizontalLayout_3.addWidget(self.T2SpinBox)
        self.T2Slider = QtWidgets.QSlider(self.groupBox_8)
        self.T2Slider.setStyleSheet("QSlider{\n"
"border-color: #bcbcbc;\n"
"color:#d9d9d9;\n"
"}\n"
"QSlider::groove:horizontal {                                \n"
...
" background: qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0, stop:0 #373737, stop:0.25 #373737, stop:0.5 #373737, stop:1 #373737);                     \n"
"}")
        self.T2Slider.setMaximum(100)
        self.T2Slider.setProperty("value", 25)
        self.T2Slider.setOrientation(QtCore.Qt.Horizontal)
        self.T2Slider.setTickPosition(QtWidgets.QSlider.NoTicks)
        self.T2Slider.setObjectName("T2Slider")
        self.horizontalLayout_3.addWidget(self.T2Slider)
...
"border-radius:0px;}")
        ...
        self.detectButton = QtWidgets.QPushButton(self.groupBox_6)
        ...
        self.detectButton.setStyleSheet("/**正常情况下样式**/\n"
"QPushButton{\n"
"font-size: 18px;\n"
"font-weight: bold;\n"
"color:white;\n"
...
"}\n"
"")
        self.detectButton.setIconSize(QtCore.QSize(20, 20))
        self.detectButton.setCheckable(True)
        self.detectButton.setObjectName("detectButton")
        self.horizontalLayout_36.addWidget(self.detectButton)
...
"border-radius:0px;}")
        ...
        self.resultWidget.setGeometry(QtCore.QRect(10, 0, 361, 311))
        self.resultWidget.setStyleSheet("QTableWidget{\n"
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        self.selectButton = QtWidgets.QPushButton(self.groupBox_201)
...
"background-color: rgba(223, 223, 223, 150);}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/img/icon/列表.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.selectButton.setIcon(icon6)
        self.selectButton.setIconSize(QtCore.QSize(30, 30))
        self.selectButton.setCheckable(True)
        self.selectButton.setObjectName("selectButton")
        self.horizontalLayout_12.addWidget(self.selectButton)
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "鸡群计数软件"))
        self.label_4.setText(_translate("mainWindow", "鸡群计数软件"))
        ...
        self.label_10.setText(_translate("mainWindow", "选择文件"))
        self.fileButton.setToolTip(_translate("mainWindow", "file"))
        self.label_2.setText(_translate("mainWindow", "Match Thresh"))
        self.label.setText(_translate("mainWindow", "Track Thresh"))
        self.detectButton.setText(_translate("mainWindow", "确认检测"))
        self.saveCheckBox.setText(_translate("mainWindow", "自动保存结果"))
        self.label_11.setText(_translate("mainWindow", "结果分析"))
